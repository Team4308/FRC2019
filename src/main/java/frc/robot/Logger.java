...
public class Logger {
    ...
    public void log() {
        ...
        SmartDashboard.putNumber("Current - Arm Motor", Robot.pdp.getCurrent(RobotMap.Power.Arm.armMotor));
        SmartDashboard.putNumber("Current - Intake Motor", Robot.pdp.getCurrent(RobotMap.Power.Intake.intakeMotor));
        ...
        SmartDashboard.putNumber("Arm Input", OI.getArmScheme());
        SmartDashboard.putNumber("Arm Output", Robot.arm.getArm());
