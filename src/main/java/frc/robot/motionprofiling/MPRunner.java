...
public class MPRunner {
	...
	private void startFilling() {
		...
		startFilling(_Points, _kNumPoints);
	}
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		_talon.configMotionProfileTrajectoryPeriod(RobotMap.Drive.MotionControl.kBaseTrajectoryPeriod, RobotMap.Drive.MotionControl.kTimeoutMs);
